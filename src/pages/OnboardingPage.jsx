...
import { z } from 'zod';
import { User, Building2, ArrowRight, ArrowLeft, Check, Loader2 } from 'lucide-react';
    ...
    <div className="min-h-screen bg-[var(--background)] px-4 py-8">
      <div className="max-w-3xl mx-auto">
        <div className="text-center mb-8">
          <h1 className="text-3xl font-bold text-[var(--foreground)]">Welcome to FinJazz</h1>
          <p className="text-[var(--muted-foreground)] mt-2">Let's set up your account</p>
        </div>
        ...
        <AnimatePresence mode="wait">
          {step === 1 && (
            ...
            >
              <Card className="p-8">
                ...
                <form onSubmit={accountTypeForm.handleSubmit(handleAccountTypeSubmit)}>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                    ...
                    >
                      ...
                      />
                      <h3 className="font-semibold text-[var(--foreground)]">Personal</h3>
          ...
          {step === 2 && (
            ...
            >
              <Card className="p-8">
                <h2 className="text-xl font-semibold text-center mb-6">Choose your theme</h2>
                ...
                <div className="flex gap-3">
                  ...
                  <Button type="button" onClick={handleThemeSubmit} className="flex-1">
                    Continue
                    <ArrowRight className="h-4 w-4 ml-2" />
                  </Button>
                </div>
          ...
          {step === 3 && (
            ...
            >
              <Card className="p-8">
                <h2 className="text-xl font-semibold text-center mb-6">Complete your profile</h2>
